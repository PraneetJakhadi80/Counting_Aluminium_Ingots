...
filename = "captured_image_{}.jpg".format(current_time)

# Specify the path to save the image
save_path = r"C:\Users\lenovo\Desktop\aon\aonimages\"

# Save the image to the specified location with the unique filename
